...
def iterateAndValidateFs(file_path,fs):
    ...
    for i in os.listdir(file_path):
            ...
            if(Fs != fs): print("Wrong Fs! "+ str(Fs) +", check "   + str(wav_path))
    return os.getcwd()

iterateAndValidateFs("C:/Users/santiago/Desktop/repository/argentinian_corpora/santiago_del_estero/wavFiles",11025)
